...
<center>
    ...
    <nav class="navbar navbar-default title1">
        ...
        <a class="navbar-brand" href="#"><b>Online Quiz Game</b></a>
        </div>
        ...
        <ul class="nav navbar-nav navbar-left">
            ...
            <li <?php if(@$_GET['q']==3) echo'class="active"'; ?>> <a href="welcome.php?q=3"><span class="glyphicon glyphicon-stats" aria-hidden="true"></span>&nbsp;Report</a></li>
